...
namespace Molytho.UnitTests.Matrix
{
    public class IntCalculationProvider
    {
        ...
        {
            (Matrix<int>, Matrix<int>)[] input =
            {
                (
                    new int[,]{{3615,6639,2699,5166},{6136,1130,4616,9260},{1031,2888,5378,4027}},
                    new int[,]{{3615, 6136, 1031}, {6639, 1130, 2888}, {2699, 4616, 5378}, {5166, 9260, 4027}}
                ),
                (
                    new int[,]{{2319,5391},{2870,945}},
                    new int[,]{{2319, 2870}, {5391, 945}}
                ),
                (
                    new int[,]{{6116,1325,7043,9594,2769},{909,46,8171,5391,5866}},
                    new int[,]{{6116, 909}, {1325, 46}, {7043, 8171}, {9594, 5391}, {2769, 5866}}
                ),
                (
                    new int[,]{{3326,5024,2790,9493,3284,5886,4994,5991}},
                    new int[,]{{3326}, {5024}, {2790}, {9493}, {3284}, {5886}, {4994}, {5991}}
                ),
                (
                    new int[,]{{5138,9097,8662,9418},{2613,6023,3162,1537},{9956,8522,2710,2083},{110,6879,6029,7767},{8726,6176,4835,3156}},
                    new int[,]{{5138, 2613, 9956, 110, 8726}, {9097, 6023, 8522, 6879, 6176}, {8662, 3162, 2710, 6029, 4835}, {9418, 1537, 2083, 7767, 3156}}
                ),
            };
